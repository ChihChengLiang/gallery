...
user_features = User_cost.merge(n_proposal_voted, left_index=True, right_index=True)
...
plt.title(f"How {polls.UserID.nunique()} Users vote in Quadratic-Voting Experiment of PDIS Hackthon")
plt.savefig('qv.png')